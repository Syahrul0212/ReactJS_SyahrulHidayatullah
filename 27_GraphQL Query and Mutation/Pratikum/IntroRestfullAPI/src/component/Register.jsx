...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      firstname: Yup.string().min(3, "First name minimum 3 characters").required(),
      lastname: Yup.string().min(3, "Last name minimum 3 characters").required(),
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-6">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <p className="mt-2">
                Sudaah memiliki akun? <Link to={"/login"}>Login sekarang!</Link>
              </p>
              <div className="form-group text-center">
                <button type="submit" className="btn btn-primary mt-3 submit" name="submit-button" width="200px">
                  Submit
                </button>
              </div>
            </form>
